...
import com.shopme.admin.setting.country.AdminCountryRepository;
import com.shopme.admin.setting.state.AdminStateRepository;
...
public class StateRestControllerTests {
	...
	@Autowired AdminCountryRepository countryRepo;
	
	@Autowired AdminStateRepository stateRepo;

...
public class AdminSettingController {
	...
	@Autowired private AdminSettingService service;
	
	@Autowired private AdminCurrencyRepository currencyRepo;
	...
	public String saveGeneralSettings(@RequestParam("fileImage") MultipartFile multipartFile,
		...
		AdminGeneralSettingBag settingBag = service.getGeneralSettings();
	...
	private void saveSiteLogo(MultipartFile multipartFile, AdminGeneralSettingBag settingBag) throws IOException {
	...
	private void saveCurrencySymbol(HttpServletRequest request, AdminGeneralSettingBag settingBag) {

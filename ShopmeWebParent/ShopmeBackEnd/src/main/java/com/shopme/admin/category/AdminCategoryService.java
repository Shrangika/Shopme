...
public class AdminCategoryService {
	...
	public List<Category> listAll() {
		return listByPage(new AdminCategoryPageInfo(), 1, "asc", null);
	}

	
	public List<Category> listByPage(AdminCategoryPageInfo pageInfo,int pageNum, String sortDir,String keyword) {
